...
<div class="twf-agencias-map-container" data-zoom="<?php echo esc_attr($atts['zoom']); ?>" data-ubicacion="<?php echo esc_attr($atts['ubicacion']); ?>" data-servicios="<?php echo esc_attr($atts['servicios']); ?>">
    ...
    <div id="twf-agencias-map" class="twf-agencias-map" style="height: <?php echo esc_attr($atts['height']); ?>px;"></div>
